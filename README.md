...
* [GitHub](https://github.com/styled-components/styled-components) ⭐ 41,102 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-11
...
* [ReaKit](https://github.com/diegohaz/reakit) ⭐ 8,613 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-17 - Toolkit for building interactive UIs.
* [Rebass](https://github.com/jxnblk/rebass) ⭐ 7,898 | 🐛 95 | 🌐 JavaScript | 📅 2023-07-27 - Functional React UI component library.
* [React95](https://github.com/arturbien/React95) ⭐ 7,267 | 🐛 45 | 🌐 TypeScript | 📅 2024-01-14 - Windows 95 style UI components.
* [reactour](https://github.com/elrumordelaluz/reactour) ⭐ 4,090 | 🐛 82 | 🌐 TypeScript | 📅 2026-05-19 - Tourist Guide into your Components.
* [react-data-table-component](https://github.com/jbetancur/react-data-table-component) ⭐ 2,232 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-16 - Data Table with built in sorting, pagination, selection, expandable rows and customizable styling.
...
* [react-css-loaders](https://github.com/LucasBassetti/react-css-loaders) ⭐ 394 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-21 - A collection of pure CSS loading components.
...
* [react-styled-flexboxgrid](https://github.com/LoicMahieu/react-styled-flexboxgrid) ⭐ 552 | 🐛 48 | 🌐 JavaScript | 📅 2024-04-02 - Grid system based on flexbox.
* [bedrock-layout-primitives](https://github.com/Bedrock-Layouts/Bedrock) ⭐ 449 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-14 - Foundational Layout Primitives for your React App
...
* [polished](https://github.com/styled-components/polished) ⭐ 7,662 | 🐛 34 | 🌐 JavaScript | 📅 2026-03-26 - Lightweight set of Sass/Compass-style mixins/helpers.
...
* [styled-breakpoints](https://github.com/maxinakenty/styled-breakpoints) ⭐ 556 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-14 - Simple and powerful custom breakpoints
...
* [webstorm-styled-components](https://github.com/styled-components/webstorm-styled-components) ⭐ 376 | 🐛 25 | 🌐 Kotlin | 📅 2026-09-17 - Highlighting support in IntelliJ editors
...
* [css-in-js-media](https://github.com/zx6658/css-in-js-media) ⭐ 140 | 🐛 10 | 🌐 TypeScript | 📅 2023-02-28 - Deal with responsive design.
...
* [styled-media-helper](https://github.com/dvpnt/styled-media-helper) ⭐ 75 | 🐛 7 | 🌐 JavaScript | 📅 2023-03-04 - Write media queries.
...
* [styled-reboot](https://github.com/alexruzzarin/styled-reboot) ⭐ 27 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-16 - Bootstrap v4 reboot.css
...
* [jest-styled-components](https://github.com/styled-components/jest-styled-components) ⭐ 1,580 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-10 - Jest utilities.

#### Boilerplates

* [react-boilerplate](https://github.com/mxstbr/react-boilerplate) ⭐ 29,475 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23 - Highly scalable, offline-first foundation with the best developer experience and a focus on performance and best practices.
* [ARc](https://github.com/diegohaz/arc) ⭐ 2,921 | 🐛 64 | 🌐 JavaScript | 📅 2022-02-12 - Atomic React App boilerplate.
...
* [en.kachkaev.ru](https://en.kachkaev.ru) - Personal homepage built with [next.js](https://github.com/zeit/next.js) ⭐ 142,329 | 🐛 3,404 | 🌐 JavaScript | 📅 2026-09-17; also uses GraphQL, Docker, CI and microservice architecture ([source on GitLab](https://gitlab.com/kachkaev/website)).
* [Strapi Admin Panel](https://github.com/strapi/strapi/tree/master/packages/strapi-admin) ⭐ 73,182 | 🐛 530 | 🌐 TypeScript | 📅 2026-09-17 - Strapi built-in admin panel to build content APIs.
* [Reactiflux](https://www.reactiflux.com) - Reactiflux community home build with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,938 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-17 ([source](https://github.com/reactiflux/reactiflux.com) ⭐ 274 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-10).
* [sachagreif.com](http://sachagreif.com) - Personal homepage built with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,938 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-17 ([source](https://github.com/SachaG/sg2017) ⭐ 24 | 🐛 28 | 🌐 JavaScript | 📅 2023-01-04).
* [Prisma](https://www.prisma.io/) - Open-Source GraphQL ORM for GraphQL Servers ([source](https://github.com/prisma/prisma) ⭐ 47,613 | 🐛 2,634 | 🌐 TypeScript | 📅 2026-09-17).
* [Outline](https://www.getoutline.com) - Wiki for your team ([source](https://github.com/outline/outline) ⭐ 40,579 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-17)
* [CodeSandbox](https://codesandbox.io/s/new) - An online editor tailored for React development ([source](https://github.com/CompuIves/codesandbox-client) ⭐ 13,642 | 🐛 615 | 🌐 JavaScript | 📅 2026-09-07).
...
* [Orbit Components](https://github.com/kiwicom/orbit-components) ⭐ 1,433 | 🐛 49 | 🌐 TypeScript | 📅 2026-07-06 - Component library of Orbit Design System, built by and for [Kiwi.com](https://www.kiwi.com)
* [njt.now.sh](https://njt.now.sh) - `njt` (npm jump to) is a tool and a service that provides package navigation shortcuts. It uses Next.js and involves server-side-rendering ([source](https://github.com/kachkaev/njt) ⭐ 318 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-15).
* [Hack Club](https://hackclub.com) - Website for a global, non-profit community of high school coding clubs ([source](https://github.com/hackclub/site) ⭐ 279 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-15)
...
* [Nulogy](https://nulogy.com) - Supply chain management software built with open-source [Nulogy Components](https://github.com/nulogy/design-system/tree/master/packages/components) ⭐ 65 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16.
...
* [Dirtyredz.com](http://dirtyredz.com) - David McClain | Dirtyredz \* About me, Latest projects and Contact ([source](https://github.com/dirtyredz/dirtyredz.com) ⭐ 11 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-16).
...
* [michaelhsu.tw](http://michaelhsu.tw) - A simple static homepage built with CRA pre-renderer ([source](https://github.com/evenchange4/michaelhsu.tw) ⭐ 8 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-10).
...
* [RAN!](https://github.com/sly777/ran) ⭐ 2,203 | 🐛 89 | 🌐 JavaScript | 📅 2026-02-14 - Production-ready boilerplate with support for GraphQL, SSR, Hot-reload, and caching.
...
* [react-progressive-bg-image](https://github.com/evenchange4/react-progressive-bg-image) ⭐ 227 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-10 - Medium style progressive background image.
...
* [styled-components-spacing](https://github.com/jameslnewell/styled-components-spacing) ⭐ 210 | 🐛 22 | 🌐 JavaScript | 📅 2022-12-09 - Responsive margin and padding components.
...
* [mcs-lite-ui](https://github.com/MCS-Lite/mcs-lite) ⭐ 75 | 🐛 50 | 🌐 JavaScript | 📅 2026-09-15 - An on-premises Internet of Things cloud platform, which can be quickly built and is fast to get started with.
