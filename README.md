...
* [GitHub](https://github.com/styled-components/styled-components) ⭐ 41,103 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-11
...
* [ReaKit](https://github.com/diegohaz/reakit) ⭐ 8,612 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-15 - Toolkit for building interactive UIs.
* [Rebass](https://github.com/jxnblk/rebass) ⭐ 7,898 | 🐛 95 | 🌐 JavaScript | 📅 2023-07-27 - Functional React UI component library.
* [React95](https://github.com/arturbien/React95) ⭐ 7,266 | 🐛 45 | 🌐 TypeScript | 📅 2024-01-14 - Windows 95 style UI components.
* [reactour](https://github.com/elrumordelaluz/reactour) ⭐ 4,090 | 🐛 82 | 🌐 TypeScript | 📅 2026-05-19 - Tourist Guide into your Components.
* [react-data-table-component](https://github.com/jbetancur/react-data-table-component) ⭐ 2,232 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-06 - Data Table with built in sorting, pagination, selection, expandable rows and customizable styling.
...
* [polished](https://github.com/styled-components/polished) ⭐ 7,663 | 🐛 34 | 🌐 JavaScript | 📅 2026-03-26 - Lightweight set of Sass/Compass-style mixins/helpers.
...
* [webstorm-styled-components](https://github.com/styled-components/webstorm-styled-components) ⭐ 376 | 🐛 25 | 🌐 Kotlin | 📅 2026-09-15 - Highlighting support in IntelliJ editors
...
* [styled-reboot](https://github.com/alexruzzarin/styled-reboot) ⭐ 27 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-10 - Bootstrap v4 reboot.css
...
* [react-boilerplate](https://github.com/mxstbr/react-boilerplate) ⭐ 29,478 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23 - Highly scalable, offline-first foundation with the best developer experience and a focus on performance and best practices.
...
* [en.kachkaev.ru](https://en.kachkaev.ru) - Personal homepage built with [next.js](https://github.com/zeit/next.js) ⭐ 142,317 | 🐛 3,364 | 🌐 JavaScript | 📅 2026-09-15; also uses GraphQL, Docker, CI and microservice architecture ([source on GitLab](https://gitlab.com/kachkaev/website)).
* [Strapi Admin Panel](https://github.com/strapi/strapi/tree/master/packages/strapi-admin) ⭐ 73,162 | 🐛 534 | 🌐 TypeScript | 📅 2026-09-15 - Strapi built-in admin panel to build content APIs.
* [Reactiflux](https://www.reactiflux.com) - Reactiflux community home build with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,939 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-15 ([source](https://github.com/reactiflux/reactiflux.com) ⭐ 274 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-10).
* [sachagreif.com](http://sachagreif.com) - Personal homepage built with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,939 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-15 ([source](https://github.com/SachaG/sg2017) ⭐ 24 | 🐛 28 | 🌐 JavaScript | 📅 2023-01-04).
* [Prisma](https://www.prisma.io/) - Open-Source GraphQL ORM for GraphQL Servers ([source](https://github.com/prisma/prisma) ⭐ 47,608 | 🐛 2,631 | 🌐 TypeScript | 📅 2026-09-15).
* [Outline](https://www.getoutline.com) - Wiki for your team ([source](https://github.com/outline/outline) ⭐ 40,550 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-14)
* [CodeSandbox](https://codesandbox.io/s/new) - An online editor tailored for React development ([source](https://github.com/CompuIves/codesandbox-client) ⭐ 13,640 | 🐛 615 | 🌐 JavaScript | 📅 2026-09-07).
...
* [Orbit Components](https://github.com/kiwicom/orbit-components) ⭐ 1,434 | 🐛 49 | 🌐 TypeScript | 📅 2026-07-06 - Component library of Orbit Design System, built by and for [Kiwi.com](https://www.kiwi.com)
* [njt.now.sh](https://njt.now.sh) - `njt` (npm jump to) is a tool and a service that provides package navigation shortcuts. It uses Next.js and involves server-side-rendering ([source](https://github.com/kachkaev/njt) ⭐ 318 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-12).
* [Hack Club](https://hackclub.com) - Website for a global, non-profit community of high school coding clubs ([source](https://github.com/hackclub/site) ⭐ 279 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-15)
...
* [Dirtyredz.com](http://dirtyredz.com) - David McClain | Dirtyredz \* About me, Latest projects and Contact ([source](https://github.com/dirtyredz/dirtyredz.com) ⭐ 11 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-08).
...
* [mcs-lite-ui](https://github.com/MCS-Lite/mcs-lite) ⭐ 75 | 🐛 50 | 🌐 JavaScript | 📅 2026-09-12 - An on-premises Internet of Things cloud platform, which can be quickly built and is fast to get started with.
