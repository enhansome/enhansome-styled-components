...
* [GitHub](https://github.com/styled-components/styled-components) ⭐ 41,101 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-24
...
* [ReaKit](https://github.com/diegohaz/reakit) ⭐ 8,624 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-25 - Toolkit for building interactive UIs.
* [Rebass](https://github.com/jxnblk/rebass) ⭐ 7,896 | 🐛 95 | 🌐 JavaScript | 📅 2023-07-27 - Functional React UI component library.
...
* [react-flex-ready](https://github.com/smakosh/react-flex-ready) ⭐ 59 | 🐛 0 | 🌐 TypeScript | 📅 2022-04-03 - FlexBox grid system with `flex-gap` property.
...
* [webstorm-styled-components](https://github.com/styled-components/webstorm-styled-components) ⭐ 376 | 🐛 25 | 🌐 Kotlin | 📅 2026-09-25 - Highlighting support in IntelliJ editors
...
* [styled-reboot](https://github.com/alexruzzarin/styled-reboot) ⭐ 27 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-24 - Bootstrap v4 reboot.css
...
* [react-boilerplate](https://github.com/mxstbr/react-boilerplate) ⭐ 29,474 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23 - Highly scalable, offline-first foundation with the best developer experience and a focus on performance and best practices.
...
* [en.kachkaev.ru](https://en.kachkaev.ru) - Personal homepage built with [next.js](https://github.com/zeit/next.js) ⭐ 142,433 | 🐛 3,480 | 🌐 JavaScript | 📅 2026-09-25; also uses GraphQL, Docker, CI and microservice architecture ([source on GitLab](https://gitlab.com/kachkaev/website)).
* [Strapi Admin Panel](https://github.com/strapi/strapi/tree/master/packages/strapi-admin) ⭐ 73,234 | 🐛 580 | 🌐 TypeScript | 📅 2026-09-25 - Strapi built-in admin panel to build content APIs.
...
* [Prisma](https://www.prisma.io/) - Open-Source GraphQL ORM for GraphQL Servers ([source](https://github.com/prisma/prisma) ⭐ 47,672 | 🐛 2,659 | 🌐 TypeScript | 📅 2026-09-25).
* [Outline](https://www.getoutline.com) - Wiki for your team ([source](https://github.com/outline/outline) ⭐ 40,700 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-25)
...
* [njt.now.sh](https://njt.now.sh) - `njt` (npm jump to) is a tool and a service that provides package navigation shortcuts. It uses Next.js and involves server-side-rendering ([source](https://github.com/kachkaev/njt) ⭐ 318 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-25).
* [Hack Club](https://hackclub.com) - Website for a global, non-profit community of high school coding clubs ([source](https://github.com/hackclub/site) ⭐ 281 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23)
...
* [react-progressive-bg-image](https://github.com/evenchange4/react-progressive-bg-image) ⭐ 227 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-24 - Medium style progressive background image.
...
* [mcs-lite-ui](https://github.com/MCS-Lite/mcs-lite) ⭐ 75 | 🐛 50 | 🌐 JavaScript | 📅 2026-09-24 - An on-premises Internet of Things cloud platform, which can be quickly built and is fast to get started with.
