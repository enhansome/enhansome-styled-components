...
* [GitHub](https://github.com/styled-components/styled-components) ⭐ 41,126 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-17
...
* [ReaKit](https://github.com/diegohaz/reakit) ⭐ 8,607 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-28 - Toolkit for building interactive UIs.
...
* [reactour](https://github.com/elrumordelaluz/reactour) ⭐ 4,086 | 🐛 82 | 🌐 TypeScript | 📅 2026-05-19 - Tourist Guide into your Components.
* [react-data-table-component](https://github.com/jbetancur/react-data-table-component) ⭐ 2,231 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-19 - Data Table with built in sorting, pagination, selection, expandable rows and customizable styling.
...
* [bedrock-layout-primitives](https://github.com/Bedrock-Layouts/Bedrock) ⭐ 449 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-28 - Foundational Layout Primitives for your React App
...
* [styled-system](https://github.com/jxnblk/styled-system) ⭐ 7,865 | 🐛 236 | 🌐 JavaScript | 📅 2024-01-12 - Design system utilities.
...
* [webstorm-styled-components](https://github.com/styled-components/webstorm-styled-components) ⭐ 376 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-26 - Highlighting support in IntelliJ editors
...
* [styled-reboot](https://github.com/alexruzzarin/styled-reboot) ⭐ 27 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-26 - Bootstrap v4 reboot.css
...
* [en.kachkaev.ru](https://en.kachkaev.ru) - Personal homepage built with [next.js](https://github.com/zeit/next.js) ⭐ 141,972 | 🐛 3,633 | 🌐 JavaScript | 📅 2026-08-28; also uses GraphQL, Docker, CI and microservice architecture ([source on GitLab](https://gitlab.com/kachkaev/website)).
* [Strapi Admin Panel](https://github.com/strapi/strapi/tree/master/packages/strapi-admin) ⭐ 73,031 | 🐛 545 | 🌐 TypeScript | 📅 2026-08-28 - Strapi built-in admin panel to build content APIs.
* [Reactiflux](https://www.reactiflux.com) - Reactiflux community home build with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 437 | 🌐 JavaScript | 📅 2026-08-28 ([source](https://github.com/reactiflux/reactiflux.com) ⭐ 274 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-27).
* [sachagreif.com](http://sachagreif.com) - Personal homepage built with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 437 | 🌐 JavaScript | 📅 2026-08-28 ([source](https://github.com/SachaG/sg2017) ⭐ 24 | 🐛 28 | 🌐 JavaScript | 📅 2023-01-04).
* [Prisma](https://www.prisma.io/) - Open-Source GraphQL ORM for GraphQL Servers ([source](https://github.com/prisma/prisma) ⭐ 47,567 | 🐛 2,574 | 🌐 TypeScript | 📅 2026-08-28).
* [Outline](https://www.getoutline.com) - Wiki for your team ([source](https://github.com/outline/outline) ⭐ 40,362 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-28)
* [CodeSandbox](https://codesandbox.io/s/new) - An online editor tailored for React development ([source](https://github.com/CompuIves/codesandbox-client) ⭐ 13,638 | 🐛 613 | 🌐 JavaScript | 📅 2026-08-25).
...
* [njt.now.sh](https://njt.now.sh) - `njt` (npm jump to) is a tool and a service that provides package navigation shortcuts. It uses Next.js and involves server-side-rendering ([source](https://github.com/kachkaev/njt) ⭐ 318 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-27).
* [Hack Club](https://hackclub.com) - Website for a global, non-profit community of high school coding clubs ([source](https://github.com/hackclub/site) ⭐ 280 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-28)
...
* [Dirtyredz.com](http://dirtyredz.com) - David McClain | Dirtyredz \* About me, Latest projects and Contact ([source](https://github.com/dirtyredz/dirtyredz.com) ⭐ 11 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-20).
...
* [mcs-lite-ui](https://github.com/MCS-Lite/mcs-lite) ⭐ 75 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-26 - An on-premises Internet of Things cloud platform, which can be quickly built and is fast to get started with.
