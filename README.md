...
* [GitHub](https://github.com/styled-components/styled-components) ⭐ 41,108 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-08
...
* [ReaKit](https://github.com/diegohaz/reakit) ⭐ 8,608 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-08 - Toolkit for building interactive UIs.
...
* [react-data-table-component](https://github.com/jbetancur/react-data-table-component) ⭐ 2,232 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-06 - Data Table with built in sorting, pagination, selection, expandable rows and customizable styling.
...
* [bedrock-layout-primitives](https://github.com/Bedrock-Layouts/Bedrock) ⭐ 449 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 - Foundational Layout Primitives for your React App
...
* [webstorm-styled-components](https://github.com/styled-components/webstorm-styled-components) ⭐ 376 | 🐛 25 | 🌐 Kotlin | 📅 2026-09-09 - Highlighting support in IntelliJ editors
...
* [en.kachkaev.ru](https://en.kachkaev.ru) - Personal homepage built with [next.js](https://github.com/zeit/next.js) ⭐ 142,235 | 🐛 3,303 | 🌐 JavaScript | 📅 2026-09-09; also uses GraphQL, Docker, CI and microservice architecture ([source on GitLab](https://gitlab.com/kachkaev/website)).
* [Strapi Admin Panel](https://github.com/strapi/strapi/tree/master/packages/strapi-admin) ⭐ 73,100 | 🐛 558 | 🌐 TypeScript | 📅 2026-09-09 - Strapi built-in admin panel to build content APIs.
* [Reactiflux](https://www.reactiflux.com) - Reactiflux community home build with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,940 | 🐛 443 | 🌐 JavaScript | 📅 2026-09-09 ([source](https://github.com/reactiflux/reactiflux.com) ⭐ 274 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-27).
* [sachagreif.com](http://sachagreif.com) - Personal homepage built with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,940 | 🐛 443 | 🌐 JavaScript | 📅 2026-09-09 ([source](https://github.com/SachaG/sg2017) ⭐ 24 | 🐛 28 | 🌐 JavaScript | 📅 2023-01-04).
* [Prisma](https://www.prisma.io/) - Open-Source GraphQL ORM for GraphQL Servers ([source](https://github.com/prisma/prisma) ⭐ 47,606 | 🐛 2,606 | 🌐 TypeScript | 📅 2026-09-09).
* [Outline](https://www.getoutline.com) - Wiki for your team ([source](https://github.com/outline/outline) ⭐ 40,502 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-08)
* [CodeSandbox](https://codesandbox.io/s/new) - An online editor tailored for React development ([source](https://github.com/CompuIves/codesandbox-client) ⭐ 13,639 | 🐛 615 | 🌐 JavaScript | 📅 2026-09-07).
...
* [Hack Club](https://hackclub.com) - Website for a global, non-profit community of high school coding clubs ([source](https://github.com/hackclub/site) ⭐ 279 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-08)
...
* [RAN!](https://github.com/sly777/ran) ⭐ 2,205 | 🐛 89 | 🌐 JavaScript | 📅 2026-02-14 - Production-ready boilerplate with support for GraphQL, SSR, Hot-reload, and caching.
...
* [react-progressive-bg-image](https://github.com/evenchange4/react-progressive-bg-image) ⭐ 227 | 🐛 25 | 🌐 JavaScript | 📅 2026-07-24 - Medium style progressive background image.
