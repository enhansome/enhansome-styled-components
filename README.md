# Awesome Styled Components with stars
...
* [GitHub](https://github.com/styled-components/styled-components) ⭐ 41,128 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-11
...
* [ReaKit](https://github.com/diegohaz/reakit) ⭐ 8,594 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-12 - Toolkit for building interactive UIs.
* [Rebass](https://github.com/jxnblk/rebass) ⭐ 7,904 | 🐛 95 | 🌐 JavaScript | 📅 2023-07-27 - Functional React UI component library.
* [React95](https://github.com/arturbien/React95) ⭐ 7,255 | 🐛 45 | 🌐 TypeScript | 📅 2024-01-14 - Windows 95 style UI components.
* [reactour](https://github.com/elrumordelaluz/reactour) ⭐ 4,087 | 🐛 82 | 🌐 TypeScript | 📅 2026-05-19 - Tourist Guide into your Components.
* [react-data-table-component](https://github.com/jbetancur/react-data-table-component) ⭐ 2,228 | 🐛 9 | 🌐 TypeScript | 📅 2026-07-22 - Data Table with built in sorting, pagination, selection, expandable rows and customizable styling.
* [styled-icons](https://github.com/jacobwgillespie/styled-icons) ⭐ 2,098 | 🐛 20 | 🌐 JavaScript | 📅 2024-07-01 - Icons from popular icon packs (Font Awesome, Material, Octicons, etc).
...
* [react-css-loaders](https://github.com/LucasBassetti/react-css-loaders) ⭐ 397 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-21 - A collection of pure CSS loading components.
* [grommet-icons](https://github.com/grommet/grommet-icons) ⭐ 342 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-12 - Iconography for grommet apps.
...
* [uiGradients](https://github.com/garetmckinley/uigradients) ⭐ 228 | 🐛 2 | 🌐 JavaScript | 📅 2019-11-05 - Drop-in component for gradients.
...
* [react-functional-select](https://github.com/based-ghost/react-functional-select) ⭐ 196 | 🐛 16 | 🌐 TypeScript | 📅 2022-12-24 - Micro-sized & micro-optimized select component.
...
* [styled-off-canvas](https://github.com/marco-streng/styled-off-canvas) ⭐ 77 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-21 - Simple one-off canvas menu.
* [react-aria-tooltip](https://github.com/egoens/react-aria-tooltip) ⭐ 57 | 🐛 22 | 🌐 JavaScript | 📅 2022-12-10 - Accessible ReactJS tooltip component.
* [grape-ui](https://github.com/napagroup/grape-ui-react) ⭐ 43 | 🐛 16 | 🌐 JavaScript | 📅 2023-07-10 - Component library using styled-system and other open source components.
* [react-styled-floating-label](https://github.com/ihor/react-styled-floating-label) ⭐ 38 | 🐛 23 | 🌐 TypeScript | 📅 2023-01-03 - Floating label component which works with any HTML input.
...
* [react-raster](https://github.com/andreasfaust/react-raster) ⚠️ Archived - Advanced Grid-System, highly customizable and ready for SSR.
* [react-flex-ready](https://github.com/smakosh/react-flex-ready) ⭐ 60 | 🐛 0 | 🌐 TypeScript | 📅 2022-04-03 - FlexBox grid system with `flex-gap` property.
* [neat-components](https://github.com/magicink/neat-components) ⚠️ Archived - Implementation of ThoughtBot's Neat grid system.
* [Cinch Layout](https://github.com/jim-at-jibba/react-native-cinch-layout) ⭐ 23 | 🐛 9 | 🌐 JavaScript | 📅 2023-01-06 - React Native grid system inspired by Hedron.
...
* [polished](https://github.com/styled-components/polished) ⭐ 7,661 | 🐛 34 | 🌐 JavaScript | 📅 2026-03-26 - Lightweight set of Sass/Compass-style mixins/helpers.
...
* [styled-breakpoints](https://github.com/maxinakenty/styled-breakpoints) ⭐ 557 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-24 - Simple and powerful custom breakpoints
...
* [webstorm-styled-components](https://github.com/styled-components/webstorm-styled-components) ⭐ 376 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-12 - Highlighting support in IntelliJ editors
...
* [styled-transition-group](https://github.com/gabiseabra/styled-transition-group) ⭐ 158 | 🐛 18 | 🌐 JavaScript | 📅 2022-12-08 - Create `react-transition-group` animations.
* [css-in-js-media](https://github.com/zx6658/css-in-js-media) ⭐ 141 | 🐛 10 | 🌐 TypeScript | 📅 2023-02-28 - Deal with responsive design.
* [styco](https://github.com/agreon/styco) ⭐ 94 | 🐛 9 | 🌐 TypeScript | 📅 2026-06-06 - VS Code extension to easily refactor JSX inline styles to styled components.
* [styled-px2vw](https://github.com/hnzycfcfed/styled-px2vw) ⭐ 92 | 🐛 5 | 🌐 JavaScript | 📅 2020-08-13 - Extension of styled-components with features for convert px to vw units.
* [styled-media-helper](https://github.com/dvpnt/styled-media-helper) ⭐ 76 | 🐛 7 | 🌐 JavaScript | 📅 2023-03-04 - Write media queries.
* [styless](https://github.com/jean343/styless) ⭐ 66 | 🐛 46 | 🌐 JavaScript | 📅 2023-01-03 - Style your components declaratively with familiar Less syntax.
...
* [styled-reboot](https://github.com/alexruzzarin/styled-reboot) ⭐ 27 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-11 - Bootstrap v4 reboot.css
...
* [jest-styled-components](https://github.com/styled-components/jest-styled-components) ⭐ 1,579 | 🐛 5 | 🌐 JavaScript | 📅 2026-06-29 - Jest utilities.

#### Boilerplates

* [react-boilerplate](https://github.com/mxstbr/react-boilerplate) ⭐ 29,490 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23 - Highly scalable, offline-first foundation with the best developer experience and a focus on performance and best practices.
...
* [en.kachkaev.ru](https://en.kachkaev.ru) - Personal homepage built with [next.js](https://github.com/zeit/next.js) ⭐ 141,754 | 🐛 4,304 | 🌐 JavaScript | 📅 2026-08-13; also uses GraphQL, Docker, CI and microservice architecture ([source on GitLab](https://gitlab.com/kachkaev/website)).
* [Strapi Admin Panel](https://github.com/strapi/strapi/tree/master/packages/strapi-admin) ⭐ 72,858 | 🐛 520 | 🌐 TypeScript | 📅 2026-08-12 - Strapi built-in admin panel to build content APIs.
* [Reactiflux](https://www.reactiflux.com) - Reactiflux community home build with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 418 | 🌐 JavaScript | 📅 2026-08-12 ([source](https://github.com/reactiflux/reactiflux.com) ⭐ 272 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-12).
* [sachagreif.com](http://sachagreif.com) - Personal homepage built with [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 418 | 🌐 JavaScript | 📅 2026-08-12 ([source](https://github.com/SachaG/sg2017) ⭐ 24 | 🐛 28 | 🌐 JavaScript | 📅 2023-01-04).
* [Prisma](https://www.prisma.io/) - Open-Source GraphQL ORM for GraphQL Servers ([source](https://github.com/prisma/prisma) ⭐ 47,566 | 🐛 2,533 | 🌐 TypeScript | 📅 2026-08-13).
* [Outline](https://www.getoutline.com) - Wiki for your team ([source](https://github.com/outline/outline) ⭐ 40,099 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-13)
* [CodeSandbox](https://codesandbox.io/s/new) - An online editor tailored for React development ([source](https://github.com/CompuIves/codesandbox-client) ⭐ 13,631 | 🐛 612 | 🌐 JavaScript | 📅 2026-07-15).
...
* [Grabient.com](https://www.grabient.com) - A beautiful and simple UI for generating web gradients. ([source](https://github.com/johnkorzhuk/grabient/) ⭐ 2,012 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-02).
...
* [njt.now.sh](https://njt.now.sh) - `njt` (npm jump to) is a tool and a service that provides package navigation shortcuts. It uses Next.js and involves server-side-rendering ([source](https://github.com/kachkaev/njt) ⭐ 318 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-12).
* [Hack Club](https://hackclub.com) - Website for a global, non-profit community of high school coding clubs ([source](https://github.com/hackclub/site) ⭐ 276 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-12)
...
* [Nulogy](https://nulogy.com) - Supply chain management software built with open-source [Nulogy Components](https://github.com/nulogy/design-system/tree/master/packages/components) ⭐ 65 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-10.
...
* [Dirtyredz.com](http://dirtyredz.com) - David McClain | Dirtyredz \* About me, Latest projects and Contact ([source](https://github.com/dirtyredz/dirtyredz.com) ⭐ 11 | 🐛 7 | 🌐 JavaScript | 📅 2023-01-03).
...
* [michaelhsu.tw](http://michaelhsu.tw) - A simple static homepage built with CRA pre-renderer ([source](https://github.com/evenchange4/michaelhsu.tw) ⭐ 8 | 🐛 18 | 🌐 JavaScript | 📅 2026-07-24).
...
* [rosesdaycare.center](https://rosesdaycare.center) - Marketing website with theme colors that change on refresh ([source](https://github.com/anthony2025/roses-daycare) ⭐ 2 | 🐛 41 | 🌐 JavaScript | 📅 2022-12-09).
...
* [Count Minutes](https://www.countminutes.com) - Application helping *you* to be in control of *your* time.
...
* [RAN!](https://github.com/sly777/ran) ⭐ 2,209 | 🐛 89 | 🌐 JavaScript | 📅 2026-02-14 - Production-ready boilerplate with support for GraphQL, SSR, Hot-reload, and caching.
* [Rebass Grid](https://github.com/rebassjs/grid) ⚠️ Archived - Responsive React grid system built with styled-system.
* [ReactQL](https://github.com/leebenson/reactql) ⚠️ Archived - Universal React + GraphQL starter kit written in Typescript w/ React 16, Apollo 2, SSR, hot-code reload, Brotli compression, strongly typed themes and support for SASS/LESS/PostCSS.
* [styled-media-query](http://github.com/morajabi/styled-media-query) ⭐ 1,308 | 🐛 22 | 🌐 JavaScript | 📅 2023-01-07 - Easily and beautifully use media queries with custom breakpoints,
* [styled-components-theme](https://github.com/erikras/styled-components-theme) ⭐ 306 | 🐛 7 | 🌐 JavaScript | 📅 2019-12-10 - Refers to theme colors and modifying them inline.
* [Reactackle](https://github.com/bcrumbs/reactackle) ⭐ 278 | 🐛 77 | 🌐 JavaScript | 📅 2022-12-10 - Open-source component library built with React and Styled Components.
* [reshake](https://github.com/elrumordelaluz/reshake) ⭐ 277 | 🐛 11 | 🌐 TypeScript | 📅 2023-07-10 - CSShake as a React Functional Component.
* [styled-props](https://github.com/RafalFilipek/styled-props) ⚠️ Archived - Allows you to set styled props in your styled-components without stress.
* [styled-components-breakpoint](https://github.com/jameslnewell/styled-components-breakpoint) ⭐ 238 | 🐛 14 | 🌐 JavaScript | 📅 2021-10-12 - Utility function for using breakpoints.
* [react-progressive-bg-image](https://github.com/evenchange4/react-progressive-bg-image) ⭐ 228 | 🐛 25 | 🌐 JavaScript | 📅 2026-07-24 - Medium style progressive background image.
* [styled-components-grid](https://github.com/jameslnewell/styled-components-grid) ⭐ 219 | 🐛 27 | 🌐 JavaScript | 📅 2023-07-15 - Responsive grid components.
* [last-draft](https://github.com/vacenz/last-draft) ⭐ 218 | 🐛 9 | 🌐 JavaScript | 📅 2018-03-08 - A Draft.js Editor.
* [styled-components-spacing](https://github.com/jameslnewell/styled-components-spacing) ⭐ 211 | 🐛 22 | 🌐 JavaScript | 📅 2022-12-09 - Responsive margin and padding components.
* [styled-flex-component](https://github.com/SaraVieira/styled-flex-component) ⭐ 209 | 🐛 8 | 🌐 JavaScript | 📅 2021-06-21 - Flex Element for not writing any more custom flex styles.
* [styled-is](https://github.com/yldio/styled-is) ⭐ 209 | 🐛 16 | 🌐 JavaScript | 📅 2023-01-06 - Flag utility for styled-components.
* [styled-loaders](https://github.com/SaraVieira/styled-loaders) ⭐ 208 | 🐛 2 | 🌐 JavaScript | 📅 2020-10-02 - Loaders Built with Preact and Styled Components.
...
* [styled-shortcuts](https://github.com/donavon/styled-shortcuts) ⭐ 88 | 🐛 3 | 🌐 JavaScript | 📅 2018-05-14 - Use simple string notation to access props. No functions necessary.
...
* [mcs-lite-ui](https://github.com/MCS-Lite/mcs-lite) ⭐ 75 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-11 - An on-premises Internet of Things cloud platform, which can be quickly built and is fast to get started with.
...
* [react-styled-flexbox](https://github.com/snikas/react-styled-flexbox) ⭐ 30 | 🐛 0 | 🌐 JavaScript | 📅 2018-09-07 - Effortlessly add flexbox styles to your components using minimal code.
* [react-awesome-notifications](https://github.com/zakariaharti/react-awesome-notifications) ⭐ 29 | 🐛 0 | 🌐 TypeScript | 📅 2018-12-24 - A beautiful fully customizable React + Redux notification system built with styled-components.
* [super-query](https://github.com/themgoncalves/super-query) ⭐ 29 | 🐛 22 | 🌐 JavaScript | 📅 2022-12-09 - Super media-query intuitive and easy of use.
* [with-styled-class-names](https://github.com/RIP21/with-styled-class-names) ⚠️ Archived - Tiny (666 bytes gzip size) helper function/high order component to help style custom classNames props like `inputClassName`, `activeClassName` etc. on 3rd party components using `styled-components`
* [colors-show](https://github.com/RafalFilipek/colors-show) ⚠️ Archived - Present your application colors with style.
* [styled-grid-responsive](https://github.com/arovillard/styled-grid-responsive) ⭐ 26 | 🐛 1 | 🌐 JavaScript | 📅 2018-05-07 - Responsive, fluid, deeply nestable, non-flexbox grid system with default or custom breakpoints.
* [styled-grid-component](https://github.com/Fausto95/styled-grid-component) ⚠️ Archived - Grid Element for not writing any more custom grid styles.
* [styled-ax](https://github.com/Lokua/styled-ax) ⭐ 23 | 🐛 0 | 🌐 JavaScript | 📅 2017-03-13 - Functional theme property accessor(s).
* [sugUI Components Library](https://github.com/gazpachu/sugui-design-system) ⭐ 18 | 🐛 0 | 🌐 JavaScript | 📅 2019-02-05 - A UI components library and design system template.
* [react-create-component-from-tag-prop](https://github.com/jameslnewell/react-create-component-from-tag-prop) ⭐ 18 | 🐛 0 | 🌐 JavaScript | 📅 2018-07-23 - Create a React component from a tag prop. Lets your users to choose which HTML elements get styled.
* [styled-shortcut-components](https://github.com/donavon/styled-shortcut-components) ⭐ 13 | 🐛 1 | 🌐 JavaScript | 📅 2022-01-18 - A convenience package that wraps `styled-components` with `styled-shortcuts`.
